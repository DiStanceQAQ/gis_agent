...
TASK_STATUS_TRANSITIONS: dict[str, set[str]] = {
    ...
    TASK_STATUS_QUEUED: {TASK_STATUS_RUNNING, TASK_STATUS_FAILED, TASK_STATUS_WAITING_CLARIFICATION},
    TASK_STATUS_WAITING_CLARIFICATION: {TASK_STATUS_QUEUED, TASK_STATUS_FAILED},
    TASK_STATUS_RUNNING: {TASK_STATUS_SUCCESS, TASK_STATUS_FAILED},
